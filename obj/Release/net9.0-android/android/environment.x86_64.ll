...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001b13, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001b12, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [882 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x1b3a860599620e41, ; from name: aot-MusicPlayer.so
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	}, ; 89
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x48d00d229186635b, ; from name: MusicPlayer.so
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x83b228f25a54c5dd, ; from name: aot-MusicPlayer.dll.so
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x85473d0e8f01d9ae, ; from name: libaot-MusicPlayer.dll.so
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8a76a6274a9980f9, ; from name: MusicPlayer.dll.so
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x976b15da7c06f228, ; from name: aot-MusicPlayer
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdc2c2a506b0ffaad, ; from name: libaot-MusicPlayer.so
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdd49996e360e23ef, ; from name: MusicPlayer
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf46be7d3e3f408b1, ; from name: libaot-MusicPlayer
		i64 u0x85473d0e8f01d9ae, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MusicPlayer.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.musicplayer\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [26 x i8] c"libaot-MusicPlayer.dll.so\00", align 16
